                ...
                <div class="flex-auto p-6">
                    <form action="{{ route('client.projects.update', $project->id) }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('dashboard.client') }}" class="inline-block px-6 py-3 mr-3 font-bold text-center text-gray-700 uppercase align-middle transition-all bg-gray-200 rounded-lg cursor-pointer leading-pro text-xs ease-soft-in shadow-soft-md hover:scale-102 hover:shadow-soft-xs hover:bg-gray-300">
                                Batal
                            </a>
