    <!-- sidenav  -->
        ...
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors
            {{ request()->routeIs('dashboard.admin') ? 'bg-blue-500/13 font-semibold text-slate-700' : 'dark:text-white dark:opacity-80' }}"
        ...
        <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors dark:text-white dark:opacity-80"
            href="#"> {{-- Biarkan # dulu karena halamannya belum ada --}}
            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
            <i class="relative top-0 text-sm leading-normal text-emerald-500 ni ni-calendar-grid-58"></i>
            </div>
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Calendar</span>
        </a>
        </li>

        <li class="w-full mt-4">
            <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase dark:text-white opacity-60">Management</h6>
        </li>

        <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors
                {{ request()->routeIs('categories.index') ? 'bg-blue-500/13 font-semibold text-slate-700' : 'dark:text-white dark:opacity-80' }}"
        ...
        <li class="w-full mt-4">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors
                    {{ request()->routeIs('settings.index') ? 'bg-blue-500/13 font-semibold text-slate-700' : 'dark:text-white dark:opacity-80' }}"
        ...
        <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors dark:text-white dark:opacity-80"
                href="#"> {{-- Biarkan # dulu, ini untuk logout logic--}}
            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
